...
const StatisticsTab = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Flow Dashboard Widget in Statistics */}
<div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
  ...
  <div className="grid grid-cols-3 gap-4 px-6 py-6 text-center">
    <div className="bg-green-100 p-4 rounded-lg shadow-sm">
      <p className="text-2xl font-bold text-green-900">{statsData.currentInBuilding}</p>
      <p className="text-lg font-bold text-gray-700">Inside Building</p>
    </div>
    <div className="bg-teal-100 p-4 rounded-lg shadow-sm">
      <p className="text-2xl font-bold text-teal-900">{statsData.currentInEvent}</p>
      <p className="text-lg font-bold text-gray-700">Inside Event</p>
    </div>
    <div className="bg-blue-100 p-4 rounded-lg shadow-sm">
      <p className="text-2xl font-bold text-blue-900">{statsData.totalRegistrations}</p>
      ...
      <table className="min-w-full text-lg font-bold text-left border border-gray-200 rounded-lg overflow-hidden">
        ...
        <tbody>
          <tr className="border-t">
            ...
            <td className="px-4 py-3">{statsData.currentInBuilding > 0 ? Math.round((statsData.currentInBuilding / 500) * 100) : 0}%</td>
          </tr>
          <tr className="border-t">
            <td className="px-4 py-3">Event</td>
            <td className="px-4 py-3 text-red-600">4000</td>
            <td className="px-4 py-3">{statsData.currentInEvent > 0 ? Math.round((statsData.currentInEvent / 4000) * 100) : 0}%</td>
          </tr>
          <tr className="border-t">
            <td className="px-4 py-3">Total</td>
            <td className="px-4 py-3 text-red-600">4500</td>
            <td className="px-4 py-3">{(statsData.currentInBuilding + statsData.currentInEvent) > 0 ? Math.round(((statsData.currentInBuilding + statsData.currentInEvent) / 4500) * 100) : 0}%</td>
          </tr>
        </tbody>
      </table>
    </div>
