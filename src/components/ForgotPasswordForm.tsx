  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl border border-orange-100 w-full max-w-md p-8 text-center fade-in-scale">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 px-4 rounded-lg font-medium hover:from-orange-600 hover:to-orange-700 btn-animate"
          >
            Back to Login
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="space-y-6">
            ...
            <button
              type="button"
              onClick={() => navigate('/login')}
              className="w-full flex items-center justify-center space-x-2 text-orange-600 hover:text-orange-700 font-medium py-2 btn-animate"
            >
